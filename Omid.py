...
jalan("   \033[1;91m AFGHAN USERZ USE ANY PROXY ")	
...
CorrectUsername = "omid"
CorrectPassword = "omari"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open t.me/omidafghan786786')
    else:
...
def pilih_super():
	...
	jalan('                    \033[1;97 omid start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
